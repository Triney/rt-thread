 ...
 ******************************************************************************
  File Name     : TelnetSvc.c
  Version       : Initial Draft
  Author        : Enix
  Created       : 2017/2/23
  Last Modified :
  Description   : telnet service implementation
  Function List :
  History       :
  1.Date        : 2017/2/23
    Author      : Enix
...
#else
#define rb_init     rt_ringbuffer_init
#define rb_put      rt_ringbuffer_put
#define rb_putchar  rt_ringbuffer_putchar
#define rb_get      rt_ringbuffer_get
#endif
